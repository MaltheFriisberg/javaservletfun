...
public class BankServiceServiceLocator extends org.apache.axis.client.Service implements  BankServiceService {
    ...
    public  BankService getBankServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
             BankServicePortBindingStub _stub = new  BankServicePortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if ( BankService.class.isAssignableFrom(serviceEndpointInterface)) {
                 BankServicePortBindingStub _stub = new  BankServicePortBindingStub(new java.net.URL(BankServicePort_address), this);
                _stub.setPortName(getBankServicePortWSDDServiceName());
                return _stub;
            }
        }
